$(document).ready(function() {
    ...
    },
    {
        ...
        "description": "Managed documentation consolidation during three SugarCRM product acquisitions. Standardized content processes across 150+ annual releases and 20+ product versions.",
        "fullDescription": "Managed documentation consolidation during three SugarCRM product acquisitions. Standardized content processes across 150+ annual releases and 20+ product versions. Integrated newly acquired product documentation into existing content ecosystem while maintaining quality and team morale.",
        ...
        const modalContent = `
            <div class="project-detail-content">
                ...
                <div class="project-detail-skills">
                    ...
                    <ul>
                        ${project.skills ? project.skills.map(skill => `<li>${skill}</li>`).join('') : ''}
                    </ul>
                </div>
